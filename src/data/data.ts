...
export const education = [
  ...
  {
    degree: "Code In Place: Python",
    school: "Stanford University",
    subject: "CS106A: Online programming course for Python's fundamentals",
    year: "May 2021",
    gpa: "",
    location: "Online",
  },
  {
    degree: "Emergency Medical Technology/Technician (EMT)",
    school: "Code One Training",
    subject: "",
    year: "August 2018",
    gpa: "",
    location: "Bronx, NY",
  },
  {
    ...
    subject:
      "Relevant coursework: Calculus I, Physics I, Physics II, Discrete Mathematics I",
    year: "2016 - 2018",
    gpa: "",
    location: "Orlando, FL",
  },
...
export const volunteering = [
  ...
  },
  {
    ...
    period: "June 2023",
    achievements: [
      "Helped organizations around the world including Africa and Tennessee, US 😊.",
      "Collaborated using WordPress to assist with features for their websites.",
      "Tackled Feedback Hub and accessibilities from one of these organizations in one day!",
    ],
    location: "Remote",
  },
  {
    ...
    period: "June 2022",
    achievements: [
      "Helped organizations around the world including Africa and Central America 😊.",
      "Collaborated using WordPress to assist with features for their websites.",
